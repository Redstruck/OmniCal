        ...
        <div className="space-y-4">
          {religions.map(religion => {
            ...
            return (
              <div 
                key={religion.name} 
                className={`group relative rounded-xl border-2 transition-all duration-200 hover:shadow-md ${
                  isSelected 
                    ? `${religion.lightColor} ${religion.borderColor} shadow-sm` 
              ...
              >
                        ...
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <label 
                            ...
                            className={`font-semibold cursor-pointer transition-colors ${
                              isSelected ? religion.textColor : 'text-gray-700'
                            }`}
                          >
                            {religion.name}
                          </label>
                ...
                {isSelected && (
                  <div className={`absolute -top-1 -right-1 w-6 h-6 ${religion.color} rounded-full flex items-center justify-center shadow-md animate-scale-in`}>
            ...
            <div className="flex flex-wrap gap-2">
              {selectedReligions.map(religion => {
                ...
                return (
                  <div 
                    key={religion}
                    className={`flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${religionData?.lightColor} ${religionData?.textColor} border ${religionData?.borderColor}`}
                  >
